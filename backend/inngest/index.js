													...
													<table class="image_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-bottom:5px;padding-left:20px;padding-right:20px;padding-top:5px;width:100%;">
																<div class="alignment" align="center">
																	<div style="max-width: 541px;"><img src="https://image.tmdb.org/t/p/${booking.show.movie.backdrop_path}" style="display: block; height: auto; border: 0; width: 100%;" width="541" alt title height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
