...
const DashBoard = () => {
  ...
  const dashboardCards = [
    ...
    { title: "Active Shows", value: dashboardData.activeShows, icon: PlayCircleIcon },
            ...
            return (
              <div key={index} className='flex items-center justify-between px-4 py-3 bg-primary/10 border border-primary/20 rounded-md max-w-50 w-full'>
                <div>
                  ...
                  <p className='text-xl font-medium mt-1'>{Array.isArray(card.value) ? card.value.length : card.value}</p>
                </div>
